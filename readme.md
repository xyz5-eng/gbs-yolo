# Dataset configuration
    Open mydata.ymal, change the path to the absolute path of the working folder, and change the train, Val, and test to the relative path of the dataset image folder
